...
Our thinking of how to use threads is as figure 1 displays: we have main thread and GUI thread. Under GUI thread create we a new thread for a new game loop. All 
